...
from starter.utils import get_device, get_mesh_renderer, load_cube_mesh
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", type=str, default="output/q2.2.gif")
