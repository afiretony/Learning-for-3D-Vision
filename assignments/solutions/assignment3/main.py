    ...
    for epoch in range(start_epoch, cfg.training.num_epochs):
        ...
        if (
            ...
            with torch.no_grad():
                ...
                imageio.mimsave('images/highres.gif', [np.uint8(im * 255) for im in test_images])
...
def main(cfg: DictConfig):
    ...
    if cfg.type == 'render':
        ...
        train_nerf(cfg)
    elif cfg.type == 'train_nerf_highres':
        train_nerf_highres(cfg)
